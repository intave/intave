...
/**
 * An {@link IntaveThreatEvent} is called every time Intave concludes a thread/violation
 * by a specific check for a specific player with a specific message and details, adding a specific amount of VL
 */
public final class IntaveThreatEvent extends IntaveEvent implements Cancellable {
  ...
  private IntaveThreatEvent() {
  }

  public void copy(Player punished, Reaction reaction, String checkName, String message, String details, double vlBefore, double vlAfter) {
  ...
  public static IntaveThreatEvent empty() {
    return new IntaveThreatEvent();
  }
